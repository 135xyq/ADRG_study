...
var _default = new _vuex.default.Store({
  ...
  actions: {
    ...
    clearUserInfo: function clearUserInfo(_ref3) {
...
var _default = {
  ...
  login: function login(data) {
    return _request.default.post('/applet/login/login', data);
  },
  //  退出登录
  logout: function logout(data) {
    return _request.default.post('/applet/login/logout', data);
  }
};
exports.default = _default;
      ...
      success: function success(res) {
        if (res.data.code == 0) {
          ...
          if (res.data.code == 403) {
            // 清空store
            _index.default.commit('clearStore');
            // 清空本地存储的token
...
exports.default = void 0;
var _default = {
  baseUrl: 'http://172.17.38.82:9000'
};
exports.default = _default;
...
var _default = {
  ...
  getCategoryList: function getCategoryList(data) {
    return _request.default.post('/applet/studycategory/list', data);
  }
};
exports.default = _default;
...
/* 249 */
/*!*******************************************!*\
  !*** D:/毕设程序/ADRG_study/api/user/user.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  getUserInfo: function getUserInfo(data) {
    return _request.default.post('/applet/appletuser/getuserinfo', data);
  },
  // 修改用户信息
  updateUserInfo: function updateUserInfo(data) {
    return _request.default.post('/applet/appletuser/edit', data);
  }
};
exports.default = _default;
...
/* 258 */
/*!*********************************************!*\
  !*** D:/毕设程序/ADRG_study/api/video/video.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  getList: function getList(data) {
    return _request.default.post('/applet/video/list', data);
  },
  // 分页获取
  getPage: function getPage(data) {
    return _request.default.post('/applet/video/page', data);
  }
};
exports.default = _default;
  ...
  return new Promise(function (resolve, reject) {
    uni.chooseImage({
      ...
      success: function success(res) {
        ...
        uni.uploadFile({
          url: _config.default.baseUrl + '/applet/upload/upload',
          filePath: tempFilePaths[0],
          name: 'file',
          formData: _index.default.getters.getToken,
          success: function success(rel) {
            var fileRes = JSON.parse(rel.data);
...
var _default = {
  //  列表
  getFeedbackList: function getFeedbackList(data) {
    return _request.default.post('/applet/feedback/list', data);
  },
  //  提交一个反馈
  publishFeedback: function publishFeedback(data) {
    return _request.default.post('/applet/feedback/publish', data);
  }
};
exports.default = _default;
...
var _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 55));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 57));
var _nvueAniMap = _interopRequireDefault(__webpack_require__(/*! ./nvue.ani-map.js */ 621));
